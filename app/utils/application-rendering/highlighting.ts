...
export default class Interaction {
    ...
    constructor(modelIdToMesh: Map<string, BaseMesh>, commIdToMesh: Map<string, ClazzCommunicationMesh>) {
      this.modelIdToMesh = modelIdToMesh;
      this.commIdToMesh = commIdToMesh;
    }

    highlight(mesh: ComponentMesh | ClazzMesh | ClazzCommunicationMesh, application: Application): void {
